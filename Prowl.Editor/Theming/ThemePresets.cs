...
public static class ThemePresets
{
    ...
    public static readonly ThemePreset[] All =
    {
        ...
        // RELIC — industrial FPS aesthetic: dark gunmetal grey + orange accents.
        new("Relic",    "#FF6B1A", "#FFB347", "#131417", "#23262B", "#E8E6E1", Solid: true,
            NeutralStops: ["#0E0F11", "#A8A29A", "#1A1C1F", "#17181B", "#23262B", "#2E3238", "#3D434B"],
            InkStops: ["#55534E", "#73716B", "#97958E", "#BFBDB6", "#E8E6E1", "#FFFFFF", "#FFFFFF"]),
    };
